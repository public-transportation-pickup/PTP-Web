...
const selectedDayMeetings = meetings.filter((meeting) =>{
        isSameDay(parseISO(meeting.startDatetime), selectedDay.toISOString().substring(0, 16))
        console.log("Meeting",meeting);
        console.log("meeting.startDatetime",meeting.startDatetime)
        console.log("selectedDay",selectedDay.toISOString().substring(0, 16))
        console.log("isSameDay",isSameDay(parseISO(meeting.startDatetime), selectedDay))
    }
