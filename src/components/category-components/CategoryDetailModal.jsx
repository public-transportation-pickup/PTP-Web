...
import DetailCategoryPage from '../../pages/category-pages/DetailCategoryPage';
import PropTypes from 'prop-types'

export default function CategoryDetailModal({buttonCheck,detailCategory,setButtonCheck}) {
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <DetailCategoryPage detailCategory={detailCategory}/>
                      </div>
                    </div>
                  </div>
                </div>
