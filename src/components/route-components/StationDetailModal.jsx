...
import DetailStationPage from '../../pages/station-pages/DetailStationPage';

export default function StationDetailModal({buttonCheck,detailStation,setButtonCheck}) {
    const [open, setOpen] = useState(buttonCheck===true? buttonCheck: false);
    console.log("Open state detail station",open)
                  ...
                  <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          <DetailStationPage detailStation={detailStation}/>
                        </div>
                      </div>
                    </div>
                  </div>
