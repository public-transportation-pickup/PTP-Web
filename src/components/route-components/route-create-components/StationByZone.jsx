...
//   }
  ...
  return (
    <div>
                <div className="bg-yellow-100 rounded-lg px-4 py-2 flex flex-col items-center">
                ...
                <div className="h-96 overflow-auto mt-1 bg-sky-100 rounded-lg p-2">
                    ...
                    <ComboboxComponent listItems={listStationbyZone} params="name" onValueChange={(e)=>addStationFunc(e)}/>
                    </div>
